...
void PowerUp::onPaddleHit(Paddle& paddle)
{
    ...
    case LASER_PADDLE:
        ...
        break;
    case TRIPLE_BALL:
        Context::get().bricksbanger->createBall();
        Context::get().bricksbanger->createBall();
        break;
    case POWER_BALL:
        Context::get().bricksbanger->applyOnEachBall(&Ball::enablePowerBall);
        break;
    case EXTRA_LIFE:
        Context::get().bricksbanger->addPlayerLife();
        break;
    case SPEED_RESET:
        Context::get().bricksbanger->applyOnEachBall(&Ball::resetSpeed);
        break;
    }
    kill();
